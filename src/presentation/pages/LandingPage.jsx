      ...
      <section className="relative z-10 max-w-3xl mx-auto space-y-10 animate-fade-in">
        ...
        <section className="pt-6">
          <div className="flex items-center gap-4 mb-5">
            ...
            <h2 className="font-display text-2xl font-medium text-pato-charcoal tracking-tight">Historial</h2>
            <div className="flex-1 h-px bg-gradient-to-r from-transparent via-pato-rose/50 to-transparent" />
          </div>
          <p className="text-sm text-pato-muted font-body text-center mb-5">Citas ya registradas.</p>
          {citas.length === 0 ? (
